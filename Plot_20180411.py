...
###! Model outputs tau change
R_C1tau = np.load("./Dropbox/PhD/Resources/P2/Squid/CODE/PY/DATA/ModelR_C_tau_20180411.npy")
R_pf1tau = np.load("./Dropbox/PhD/Resources/P2/Squid/CODE/PY/DATA/ModelR_pf_tau_20180411.npy")
NoR_C1tau = np.load("./Dropbox/PhD/Resources/P2/Squid/CODE/PY/DATA/ModelNoR_C_tau_20180411.npy")
NoR_pf1tau = np.load("./Dropbox/PhD/Resources/P2/Squid/CODE/PY/DATA/ModelNoR_pf_tau_20180411.npy")
...
###! Load data
df1 = pd.read_excel('./Dropbox/PhD/Deliverables/4_April/Week1/PriceVolDataCorrectedTEST.xlsx', sheetname='Sheet1')
...
ax1.scatter(R_C1tau, R_pf1tau, s=30, c='g', marker="o", label='Others data')
ax1.scatter(NoR_C1tau, NoR_pf1tau, s=30, c='r', marker="s", label='SR data')
