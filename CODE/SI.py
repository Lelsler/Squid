...
# x-axis
ax1.set_xticklabels(np.arange(1996,2017,5), rotation=45, fontsize= 12)
...
fig = plt.figure()
ax1 = fig.add_subplot(111)
line1, = ax1.plot(efo, color = "black", linewidth=2)
line2, = ax1.plot(eff[6:], color = "red", linewidth=2)
# x-axis
ax1.set_xticklabels(np.arange(1996,2017,5), rotation=45, fontsize= 12)
# y-axis
plt.ylabel("Effort", rotation=90, labelpad=5, fontsize=20, **hfont)
plt.legend([line1,line2], ["Optimization","Simulation"], loc='best', fontsize= 12)
# fig.savefig('./Dropbox/PhD/Resources/Squid/Squid/CODE/Squid/FIGS/SI_effort.png',dpi=500)
plt.show()
