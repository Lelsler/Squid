...
### Parameters #################################################################
a0 = -40.9079 # SST anomaly intersect
a1 = 0.020464 # SST anomaly trend
a2 = 0.165387 # SST anomaly period
a3 = - 0.287384 # SST anomaly period
k = -0.0059 # q, slope
l = 0.1882 # q, intersect
qc = 0.1 # catchability constant
alpha = 1/251266009027660.94 # migration trigger
lamda = 100
...
ys = df1['M'] # migration data from long catch timeseries
